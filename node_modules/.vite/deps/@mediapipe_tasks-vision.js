...
var Lr = class {
  ...
  j() {
    ...
    if (B && r2 && null != ((_a2 = e2[r2]) == null ? void 0 : _a2[n2]) && U(W, 3), e2 = t2.g, $ && H && void 0 === $ && (r2 = (n2 = this.v)[H]) && (r2 = r2.da))
      try {
        r2(n2, e2, Le);
      } catch (t3) {
        u(t3);
...
function Xo(t2) {
  ...
  if ((e2 = (_a2 = yn(t2, Es, 4)) == null ? void 0 : _a2.l()) && (s2.boundingBox = { originX: kn(e2, 1, qe) ?? 0, originY: kn(e2, 2, qe) ?? 0, width: kn(e2, 3, qe) ?? 0, height: kn(e2, 4, qe) ?? 0, angle: 0 }), (_b = yn(t2, Es, 4)) == null ? void 0 : _b.g().length)
...
var pa = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = yn(this.baseOptions, Vs, 1)) == null ? void 0 : _c2.g()) || ((_d = yn(this.baseOptions, Vs, 1)) == null ? void 0 : _d.l()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath)))
...
var Fc = class extends dc {
  ...
  o(t2) {
    ...
    if (xn(this.A, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.A, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.u, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.D, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && ((_b = yn(this.h, to, 3)) == null ? void 0 : _b.g());
